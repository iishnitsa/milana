...
openai_base_url: str = ""
ollama_base_url: str = ""
openai_timeout: Optional[int] = 0  # 0 = бесконечный таймаут по умолчанию
...
def _get_timeout_value() -> Optional[int]:
...
def _make_request(api_url: str, payload: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def connect(connection_string: str, timeout: int = 30) -> List[Any]:
    ...
    params = {
        ...
        "ollama": "False",
        "timeout": "0",  # 0 = бесконечный таймаут по умолчанию
    }
    ...
    try:
        ...
        openai_timeout = 0  # По умолчанию бесконечный при ошибке парсинга
