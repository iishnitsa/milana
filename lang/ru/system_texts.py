...
warn_command_text_6 = 'Если вы НЕ пытались вызвать команду, используйте !!!пропустить!!! в самом начале сообщения, и затем напишите ваше сообщение ещё раз — оно будет отправлено собеседнику (например, "!!!пропустить!!! Я хочу сказать, что...").'
