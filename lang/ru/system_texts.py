...
start_dialog_tool_text = 'Прочитай промпт для оператора и напиши имена инструментов через запятую из имеющихся, которые нужны данному оператору для контроля результатов исполнителя. Например: "tool_name1, tool_name2". Если ни одна не подходит, напиши: "None". Имеющиеся инструменты:\n'
...
Собеседик не знает, что ты вызываешь функцию, и не видит ответа функции.
