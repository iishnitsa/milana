...
TEXTS = {
    ...
    "hierarchy_limit_desc": "Максимальное количество уровней вложения в иерархии агентов. Влияет на глубину обработки задачи и количество итераций. ВАЖНО: ограничение пока не работает корректно (в т.ч. значение 1) — лучше оставить 0; починка запланирована на следующий релиз.",
